...
ceEditors.code = {
	...
	*/
	setupEditor : function(){
		...
		$("input[type=radio][name=language][value="+langg+"]", editor).attr('checked','checked');
	...
	save : function(){
		...
		var html = value;
		var langg = $("input[type=radio][name=language]:checked", editor).val();
